"""
Implementation of the Bunkin4.py function
...
class Bunkin4(CostFunctions):
    """
    Implementation of the Bunkin4.py function from
    ...
    def func(self, x):
        ...
        x1 = x[0]
        x2 = x[1]
        value = 100*np.power(x2,2) + 0.01*np.abs(x1+10)
        return value