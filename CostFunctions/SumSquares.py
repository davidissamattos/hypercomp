"""
Implementation of the SumSquares function
...
__all__ = ['SumSquaresN2', 'SumSquaresN6', 'SumSquaresN10', 'SumSquaresN20']


class SumSquares(CostFunctions):
    """
    Implementation of the SumSquares function from
...
class SumSquaresN10(SumSquares):
    functionProperties = SumSquares.functionProperties
...
class SumSquaresN20(SumSquares):
    functionProperties = SumSquares.functionProperties
