"""
Implementation of the BiggsEXP2.py function
...
class BiggsEXP2(CostFunctions):
    """
    Implementation of the BiggsEXP2.py function from 
    ...
    def func(self, x):
        ...
        for i in range(11):
            ...
            value = value + np.power((np.exp(-ti*x1) - 5*np.exp(-ti*x2) - yi),2)
        return value