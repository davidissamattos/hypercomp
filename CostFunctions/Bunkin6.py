"""
Implementation of the Bunkin6.py function
...
class Bunkin6(CostFunctions):
    """
    Implementation of the Bunkin6.py function from
    ...
    def func(self, x):
        ...
        x1 = x[0]
        x2 = x[1]
        value = 100*np.sqrt(np.abs(x2-0.01*np.power(x1,2))) +0.01*np.abs(x1+10)
        return value