"""
Implementation of the Zakharov function
...
__all__ = ['ZakharovN2', 'ZakharovN6', 'ZakharovN10', 'ZakharovN20']


class Zakharov(CostFunctions):
    """
    Implementation of the Zakharov function from
    ...
    def func(self, x):
        ...
        value = np.sum(x ** 2.0) + (0.5 * np.sum(rng * x)) ** 2.0 + (0.5 * np.sum(rng * x)) ** 4.0
        return value


class ZakharovN2(Zakharov):
    functionProperties = Zakharov.functionProperties

    def __init__(self, functionProperties, sd=1, maxfeval=10):
        super().__init__(functionProperties, N=2, sd=sd, maxfeval=maxfeval)


class ZakharovN6(Zakharov):
    functionProperties = Zakharov.functionProperties
