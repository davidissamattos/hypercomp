"""
Implementation of the Schwefel2d23 function
...
__all__ = ['Schwefel2d23N2', 'Schwefel2d23N6', 'Schwefel2d23N10', 'Schwefel2d23N20']


class Schwefel2d23(CostFunctions):
    """
    Implementation of the Schwefel2d23 function from
...
class Schwefel2d23N2(Schwefel2d23):
    functionProperties = Schwefel2d23.functionProperties

    def __init__(self, functionProperties, sd=1, maxfeval=10):
        super().__init__(functionProperties, N=2, sd=sd, maxfeval=maxfeval)


class Schwefel2d23N6(Schwefel2d23):
    functionProperties = Schwefel2d23.functionProperties
...
class Schwefel2d23N10(Schwefel2d23):
    functionProperties = Schwefel2d23.functionProperties
...
class Schwefel2d23N20(Schwefel2d23):
    functionProperties = Schwefel2d23.functionProperties
