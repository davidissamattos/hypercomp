"""
Implementation of the Schwefel2d21 function
...
__all__ = ['Schwefel2d21N2', 'Schwefel2d21N6', 'Schwefel2d21N10', 'Schwefel2d21N20']


class Schwefel2d21(CostFunctions):
    """
    Implementation of the Schwefel2d21 function from
...
class Schwefel2d21N2(Schwefel2d21):
    functionProperties = Schwefel2d21.functionProperties

    def __init__(self, functionProperties, sd=1, maxfeval=10):
        super().__init__(functionProperties, N=2, sd=sd, maxfeval=maxfeval)


class Schwefel2d21N6(Schwefel2d21):
    functionProperties = Schwefel2d21.functionProperties
...
class Schwefel2d21N10(Schwefel2d21):
    functionProperties = Schwefel2d21.functionProperties
...
class Schwefel2d21N20(Schwefel2d21):
    functionProperties = Schwefel2d21.functionProperties
